'''
Used to generate 'fake' examples from a trained model.
'''
...
def generate_examples(model_mode, smiles_idx, numel, gen_mode, model_directory, gen_excel_name, selected_c=None,
    ...
    fl, eval_fl = fl.create_subsetsplit([-1])
...
if __name__ == '__main__':
    generate_examples(model_mode='SVM', loader_excel_file='./excel/data_loader/gold_data_loader',
                      smiles_idx=0, numel=300, gen_mode=3, selected_c=[0,1,2,3,4], selected_tolerance=[0.2,0.1,0,0.1,0.1],
                      selected_range=[[7, 14], [0, 100]], model_directory='./save/models/final/SVM_desc_all',
                      gen_excel_name='gen_lig')
