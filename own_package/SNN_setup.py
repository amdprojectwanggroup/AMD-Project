'''
1. create_SNN_hparams : Used to generate a dict of SNN hyperparameters for the SNN model
2. SNN / SNN_smiles : Class that creates SNN model without / with smiles
3. Siamese_loader: Used to carry out training, evaluating, and predicting of SNN model.
'''

import keras.backend as K
import tensorflow as tf
from keras.models import Sequential, Model, load_model
from keras.layers import Dense, Dropout, merge, Input, Lambda
...
class SNN:
    def __init__(self, SNN_hparams, fl):
        ...
        # Concat features_c and fingerprint vectors ==> form intermediate input vector (IIV)
        ...
        # half_model ==> L1 distance and final node model
...
class Siamese_loader:
    def __init__(self, model, x_train, SNN_hparams):
        ...
        :param SNN_hparams: Dict of hyperparameters
        """
        # General attributes
    ...
    def oneshot_predict(self, x_predict_c_norm_a):
        """

        :param x_predict_c_norm_a: np array of no. examples x features_dim
