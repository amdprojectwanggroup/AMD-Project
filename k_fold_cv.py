...
def run_skf(model_mode, cv_mode, hparams, loader_file, skf_file='./excel/skf.xlsx', skf_sheet=None,
    ...
    '''
    Stratified k fold cross validation for training and evaluating model.
    ...
    :param save_model: Whether to save model as a h5 file
    :param save_model_name: Name of save model file
    :param save_model_dir: Directory to save model in
    '''
...
if __name__ == '__main__':
    ...
    hparams = create_SNN_hparams(epochs=25, batch_size=32, pair_size=32, hidden_layers=[60], feature_vector_dim=50,
                                 dropout=0.5, singlenet_l1=0.001, singlenet_l2=0.001, verbose=0,
                                 fp_length=10, fp_number=3, conv_width=32, conv_number=2, conv_activation='leakyrelu',
                                 conv_l1=0.001, conv_l2=0.001)

    run_skf(model_mode='SNN_smiles', cv_mode='skf', hparams=hparams,
            loader_file='./excel/data_loader/gold_data_loader_aq_Au25.xlsm',
            skf_file='./excel/cv/gold_skf.xlsx', skf_sheet=skf_sheet, k_folds=10, k_shuffle=True,
            save_model_name='aq_Au25', save_model=True)
